...
const ASSETS: Record<FinzaProductAssetId, FinzaProductAsset> = {
  ...
  payroll: {
    ...
    title: "Payroll records in the same business workspace",
    description:
      "Keep salary runs and payroll records connected to the wider business record, with clear review before final use.",
    caption: "Payroll records sit alongside invoices, expenses, and reports.",
    width: 2400,
    height: 1350,
