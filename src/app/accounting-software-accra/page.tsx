        ...
        <Container>
          <div className="max-w-3xl space-y-6">
            <span className="inline-flex items-center rounded-full border border-zinc-200 bg-zinc-50 px-4 py-1.5 text-xs font-semibold uppercase tracking-wide text-zinc-600">
              Accra Â· Ghana cedis Â· Reports
            </span>
            <h1 className="text-4xl font-extrabold leading-[1.1] tracking-tight text-zinc-900 sm:text-5xl">
              Accounting software in Accra for growing businesses
            </h1>
            <p className="max-w-2xl text-lg leading-relaxed text-zinc-600">
              Accra pulls in fast-moving service companiesâ€”agencies, consultancies, clinics, law and professional firmsâ€”where clients expect clear invoices and leadership expects numbers that survive a board or lender conversation. Finza is{" "}
            ...
            <p className="max-w-2xl text-sm leading-relaxed text-zinc-500">
              You do not need a separate â€œAccra editionâ€â€”the same Finza workspace supports businesses operating from the capital and elsewhere. This page is for how those teams tend to work: more clients, more recurring work, and more pressure to hand a clean file to an accountant.
            </p>
        ...
        <Container>
          <div className="mx-auto max-w-3xl space-y-6">
            ...
            <p className="text-base leading-relaxed text-zinc-600">
              ...
              <strong className="text-zinc-900">training providers</strong>, and <strong className="text-zinc-900">B2B suppliers</strong> billing corporate clients on net terms. The pattern is the same: many invoices, follow-ups, and a finance contact or accountant who needs structureâ€”not screenshots.
            </p>
          </div>
        </Container>
      </section>
      ...
      <section className="border-b border-zinc-100 py-20">
        <Container>
          <div className="mx-auto max-w-3xl space-y-6">
            ...
            <p className="text-base leading-relaxed text-zinc-600">
              When new work lands every week, â€œwe will fix the books laterâ€ stops working. Invoices sit in email threads, partial payments do not match line items, and VAT or NHIL treatment drifts until someone has to explain it to a firm or the tax office.{" "}
              <strong className="text-zinc-900">Accounting software for businesses in Accra</strong> should mean the same numbers in billing, collections, and management reportsâ€”not three versions of the truth.
            </p>
          </div>
        </Container>
      </section>
        ...
        <Container>
          <div className="mx-auto max-w-3xl space-y-6">
            ...
            <p className="text-base leading-relaxed text-zinc-600">
              ...
              <strong className="text-zinc-900">VAT, NHIL, and GETFund</strong> can stay visible where your registration requiresâ€”instead of one guessed percentage. You can pair day-to-day recording with{" "}
        ...
        <Container>
          <div className="mx-auto max-w-3xl rounded-xl border border-zinc-200 bg-white p-8 shadow-sm">
            ...
            <ol className="mt-4 list-decimal space-y-3 pl-5 text-sm leading-relaxed text-zinc-600">
              <li>Issue or send invoices to clientsâ€”balances and receivables update from what you actually billed.</li>
              <li>Record expenses and payments as the week movesâ€”MoMo, bank, and cash in GHS.</li>
              <li>Review profit and position views before leadership or lender conversationsâ€”without rebuilding Excel.</li>
        ...
        <Container>
          <div className="mx-auto max-w-3xl space-y-4 text-center sm:text-left">
            ...
            <p className="text-sm leading-relaxed text-zinc-600">
              Finza is designed for real Ghana workflowsâ€”GHS, local tax line presentation where applicable, and operators who work with accountants. Whether your team sits in Accra, Kumasi, or several towns, you run the same product on published{" "}
          ...
          <div className="mx-auto max-w-2xl">
            ...
            <Accordion type="single" collapsible className="mt-6 w-full">
              <AccordionItem value="accra">
                ...
                <AccordionContent>
                  Yes. Finza is built for Ghana businesses operating from Accra and anywhere else in the countryâ€”cloud software with plans in GHS. It fits growing companies and professional service firms that invoice often, record expenses, and need reports and tax summaries without spreadsheet chaos.
                </AccordionContent>
              </AccordionItem>
              <AccordionItem value="ghs">
                <AccordionTrigger>Can Finza handle accounting in Ghana cedis?</AccordionTrigger>
                <AccordionContent>
                  Yes. Amounts, customer balances, and reports are in Ghana cedis (GHS). Tax-related summaries can reflect VAT, NHIL, and GETFund where applicable to your setupâ€”confirm final treatment with your accountant or GRA.
                </AccordionContent>
              </AccordionItem>
              <AccordionItem value="together">
                <AccordionTrigger>Does Finza support invoices and reports together?</AccordionTrigger>
                <AccordionContent>
                  Yes. Invoicing, payments, and expenses feed the same workspace as profit and position viewsâ€”so you are not reconciling a billing tool against a separate report file each month.
                </AccordionContent>
              </AccordionItem>
