...
export default function sitemap(): MetadataRoute.Sitemap {
    ...
    return [
        ...
        {
            url: "https://www.finza.africa/invoicing-software-ghana",
            lastModified: now,
            changeFrequency: "monthly",
            priority: 0.8,
        },
        {
            url: "https://www.finza.africa/quotation-software-ghana",
            lastModified: now,
            changeFrequency: "monthly",
            priority: 0.72,
        },
        ...
        {
            url: "https://www.finza.africa/invoice-tracking-software-ghana",
            lastModified: now,
            changeFrequency: "monthly",
            priority: 0.74,
        },
        {
            url: "https://www.finza.africa/quickbooks-alternative-ghana",
            lastModified: now,
            changeFrequency: "monthly",
            priority: 0.76,
        },
        {
            url: "https://www.finza.africa/sage-accounting-alternative-ghana",
            lastModified: now,
            changeFrequency: "monthly",
            priority: 0.76,
        },
        {
            url: "https://www.finza.africa/accounting-software-for-cleaning-business-ghana",
            lastModified: now,
            changeFrequency: "monthly",
            priority: 0.73,
        },
        {
            url: "https://www.finza.africa/invoice-software-for-contractors-ghana",
            lastModified: now,
            changeFrequency: "monthly",
            priority: 0.73,
        },
        {
            url: "https://www.finza.africa/bookkeeping-for-small-business-ghana",
            lastModified: now,
            changeFrequency: "monthly",
            priority: 0.73,
        },
