        ...
        <Container>
          <div className="max-w-3xl space-y-6">
            <span className="inline-flex items-center rounded-full border border-zinc-200 bg-zinc-50 px-4 py-1.5 text-xs font-semibold uppercase tracking-wide text-zinc-600">
              Kumasi Â· Invoices Â· GHS
            </span>
            <h1 className="text-4xl font-extrabold leading-[1.1] tracking-tight text-zinc-900 sm:text-5xl">
              Invoicing software in Kumasi for service businesses
            </h1>
            <p className="max-w-2xl text-lg leading-relaxed text-zinc-600">
              Kumasi runs on relationshipsâ€”construction crews, fit-out contractors, equipment hire, training outfits, and traders who also do project work. The weak link is usually billing: an agreed price in conversation, a handwritten note, then a scramble to remember who still owes what.{" "}
            ...
            <p className="max-w-2xl text-sm leading-relaxed text-zinc-500">
              Finza is the same product nationwideâ€”you choose Kumasi on this page because the work patterns here lean hard on quotes, milestones, and follow-up. You are not buying a different SKU; you are choosing wording that matches how you sell.
            </p>
        ...
        <Container>
          <div className="mx-auto max-w-3xl space-y-6">
            ...
            <p className="text-base leading-relaxed text-zinc-600">
              ...
              <strong className="text-zinc-900">small manufacturers</strong> selling B2B, and <strong className="text-zinc-900">professional service providers</strong> who quote first and bill after sign-off. The win is simple: every issued invoice updates the same unpaid listâ€”whether the client pays by bank, MoMo, or cash.
            </p>
          </div>
        </Container>
      </section>
      ...
      <section className="border-b border-zinc-100 py-20">
        <Container>
          <div className="mx-auto max-w-3xl space-y-6">
            ...
            <h2 className="text-3xl font-bold text-zinc-900">â€œI will send the invoice tonightâ€ should not be your system</h2>
            <p className="text-base leading-relaxed text-zinc-600">
      ...
      <section className="border-b border-zinc-100 bg-zinc-50 py-20">
        <Container>
          <div className="mx-auto max-w-3xl space-y-6">
            ...
            <p className="text-base leading-relaxed text-zinc-600">
              Start from an approved quotation when the job was scoped in stagesâ€”then convert without retyping. Issue invoices when work is ready; record payments when they hit your account. For national context and deeper reporting, pair with{" "}
        ...
        <Container>
          <div className="mx-auto max-w-3xl rounded-xl border border-zinc-200 bg-white p-8 shadow-sm">
            ...
            <ol className="mt-4 list-decimal space-y-3 pl-5 text-sm leading-relaxed text-zinc-600">
              ...
              <li>Record part-payments or full settlementâ€”status updates for the whole team.</li>
          ...
          <div className="mx-auto max-w-2xl">
            ...
            <Accordion type="single" collapsible className="mt-6 w-full">
              <AccordionItem value="ghs">
                ...
                <AccordionContent>
                  Yes. You create and send professional invoices in Ghana cedis (GHS), with tax lines shown separately where applicable for your businessâ€”not one blended tax column by default.
                </AccordionContent>
              </AccordionItem>
              <AccordionItem value="unpaid">
                <AccordionTrigger>Can Finza help track unpaid invoices?</AccordionTrigger>
                <AccordionContent>
                  Yes. You see outstanding balances by customer, which invoices are unpaid or overdue, and when payments are recordedâ€”so collections are not a separate spreadsheet.
                </AccordionContent>
              </AccordionItem>
              <AccordionItem value="kumasi">
                <AccordionTrigger>Is Finza suitable for service businesses in Kumasi?</AccordionTrigger>
                <AccordionContent>
                  Yes. Service companies, contractors, and growing SMEs in Kumasi that bill clients regularly are a strong fitâ€”especially when quotes become invoices without retyping.
                </AccordionContent>
              </AccordionItem>
